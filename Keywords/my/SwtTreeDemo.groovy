...
public class SwtTreeDemo {
	...
	public static void main(String[] args) {
		...
		Path json = projectDir.resolve("Include/config/ProfilesTree.json")
		JsonSlurper slurper = new JsonSlurper()
		def profilesTree = slurper.parse(json.toFile())
		//println JsonOutput.prettyPrint(JsonOutput.toJson(profilesTree))
